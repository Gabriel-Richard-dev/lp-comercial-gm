...
export function createMapScene(canvas, container, { onSelect } = {}) {
  ...
  scene.fog = new THREE.Fog(0xffffff, 55, 130);
  ...
  function setupLights() {
    ...
    scene.add(new THREE.HemisphereLight(0xdceaff, 0xcfcabb, 0.5));

    const sun = new THREE.DirectionalLight(0xfff6ea, 1.0);
  ...
  function createFloor() {
    ...
    const grid = new THREE.GridHelper(span, Math.ceil(span / 2), 0xc2c2be, 0xd6d6d2);
